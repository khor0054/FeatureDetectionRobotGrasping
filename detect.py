...
import argparse  # create set of params
import os
import sys
...
from outline_center import print_parameters



@torch.no_grad()
def detect_corners_lines(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # create global list, append pred
...
def show_detections(mode,
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            im0 = print_parameters(mode, im0, cX, cY, contours, left, right, all)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        ...
                        help='model path(s)')  # IMPORTANT TO CHANGE
    ...
    parser.add_argument('--conf-thres', type=float, default=0.25, help='confidence threshold')  # IMPORTANT TO CHANGE
    parser.add_argument('--iou-thres', type=float, default=0.2, help='NMS IoU threshold')
    parser.add_argument('--max-det', type=int, default=1000, help='maximum detections per image')
    parser.add_argument('--device', default='3',
                        help='cuda device, i.e. 0 or 0,1,2,3 or cpu')  # IMPORTANT TO CHANGE TO 0
    ...
    parser.add_argument('--classes', nargs='+', type=int,
                        help='filter by class: --classes 0, or --classes 0 2 3')  # IMPORTANT TO CHANGE
